...
4. Скачайте датасет, расположенный по адресу https://www.kaggle.com/datasets/pigment/big-sales-data -> Books_rating. Распакуйте его и поместите файл `Books_rating.csv` в директорию `data` проекта (если директория отсутствует, создайте ее).
